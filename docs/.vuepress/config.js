...
module.exports = {
  ...
  head: [
    ...
    [
      'meta',
      { property: 'og:image', content: 'https://smilo.foundation/og-image.png' }
    ],
    ...
    [
      'meta',
      {
        ...
        content: 'https://smilo.foundation/og-image-twitter.png'
      }
    ],
    // Matomo tracking
    ...
    //     _paq.push(['setCookieDomain', '*.smilo.foundation']);
    //     _paq.push(['setDomains', ['*.smilo.foundation']]);
    //     _paq.push(['trackPageView']);
    //     _paq.push(['enableLinkTracking']);
    //     (function() {
    //       var u='//matomo.smilo.foundation/piwik/';
    ...
    //   'noscript',
    //   {},
    //   `<p><img src="//matomo.smilo.foundation/piwik/matomo.php?idsite=4&amp;rec=1" style="border:0;" alt="" /></p>`
    // ]
  ],
  markdown: {
