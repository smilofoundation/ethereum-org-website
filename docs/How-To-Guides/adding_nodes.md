...
When adding new nodes to the network, it is important understand that the Smilo network and Private Transaction 
...
- [Smilo installed](/Getting%20Started/Installing.md)
...
Adding a new Smilo node is the most common operation, as you can choose to run a Smilo node with or without a Private 
...
This tutorial uses [Tessera](https://github.com/smilofoundation/tessera) for any examples.
...
does for Smilo. Only IP addresses/hostnames listed in your peers list will be allowed to connect to you.
