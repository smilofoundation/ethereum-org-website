...
Please refer to [set up](../setup). For an existing network running with an older version of Smilo:

* Upgrade Smilo to the latest version 
...
For a new network using the latest version of Smilo:
...
> smiloPermission.getOrgDetails("ADMINORG")
{
  acctList: [{
...
Once the network is up, the network admin accounts can then propose a new organization into the network. Majority approval from the network admin accounts is required before an organization is approved. The APIs for [proposing](../Permissioning%20apis#smilopermission_addorg) and [approving](../Permissioning%20apis#smilopermission_approveorg) an organization are documented in [permission APIs](../Permissioning%20apis)

#### Example
An example to propose and approve an organization by name `ORG1` is as shown below:

```javascript
> smiloPermission.addOrg("ORG1", "enode://de9c2d5937e599930832cecc1df8cc90b50839bdf635c1a4e68e1dab2d001cd4a11c626e155078cc65958a72e2d72c1342a28909775edd99cc39470172cce0ac@127.0.0.1:21004?discport=0", "0x0638e1574728b6d862dd5d3a3e0942c3be47d996", {from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d"})
...
```javascript
> smiloPermission.approveOrg("ORG1", "enode://de9c2d5937e599930832cecc1df8cc90b50839bdf635c1a4e68e1dab2d001cd4a11c626e155078cc65958a72e2d72c1342a28909775edd99cc39470172cce0ac@127.0.0.1:21004?discport=0", "0x0638e1574728b6d862dd5d3a3e0942c3be47d996", {from: "0xca843569e3427144cead5e4d5999a3d0ccf92b8e"})
"Action completed successfully"
> smiloPermission.orgList[1]
{
    fullOrgId: "ORG1",
...
```javascript
> smiloPermission.getOrgDetails("ORG1")
{
    acctList: [{
...
To add a sub org at `ORG1` level refer to [addSubOrg API](../Permissioning%20apis#smilopermission_addsuborg)
```javascript
> smiloPermission.addSubOrg("ORG1", "SUB1", "enode://239c1f044a2b03b6c4713109af036b775c5418fe4ca63b04b1ce00124af00ddab7cc088fc46020cdc783b6207efe624551be4c06a994993d8d70f684688fb7cf@127.0.0.1:21006?discport=0", {from: eth.accounts[0]})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1")
{
  acctList: null,
  nodeList: [{
      orgId: "ORG1.SUB1",
...
```javascript
> smiloPermission.addAccountToOrg("0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0", "ORG1.SUB1", "SUBADMIN", {from: "0x0638e1574728b6d862dd5d3a3e0942c3be47d996"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1")
{
  acctList: [{
...
```javascript
> smiloPermission.addNewRole("ORG1.SUB1", "TRANSACT", 1, false, true,{from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").roleList
[{
    access: 3,
    active: true,
    isAdmin: true,
...
To add an account to an organization refer to [addAccountToOrg API](../Permissioning%20apis#smilopermission_addaccounttoorg).
```javascript
> smiloPermission.addAccountToOrg("0x283f3b8989ec20df621166973c93b56b0f4b5455", "ORG1.SUB1", "SUBADMIN", {from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").acctList
...
To suspend an account [updateAccountStatus](../Permissioning%20apis#smilopermission_updateaccountstatus) API can be invoked with action as 1.
```javascript
> smiloPermission.updateAccountStatus("ORG1.SUB1", "0x283f3b8989ec20df621166973c93b56b0f4b5455", 1, {from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").acctList
[{
    acctId: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0",
...
To revoke suspension of an account [updateAccountStatus](../Permissioning%20apis#smilopermission_updateaccountstatus) API can be invoked with action as 2.
```javascript
> smiloPermission.updateAccountStatus("ORG1.SUB1", "0x283f3b8989ec20df621166973c93b56b0f4b5455", 2, {from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").acctList
...
To [blacklist an account updateAccountStatus](../Permissioning%20apis#smilopermission_updateaccountstatus) API can be invoked with action as 3. Once blacklisted no further activity will be possible on the account.
```javascript
> smiloPermission.updateAccountStatus("ORG1.SUB1", "0x283f3b8989ec20df621166973c93b56b0f4b5455", 3, {from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").acctList
...
To [add Nodes ](../Permissioning%20apis#smilopermission_addnode) at organization and sub organization level by the org admin.
```javascript
> smiloPermission.addNode("ORG1.SUB1", "enode://eacaa74c4b0e7a9e12d2fe5fee6595eda841d6d992c35dbbcc50fcee4aa86dfbbdeff7dc7e72c2305d5a62257f82737a8cffc80474c15c611c037f52db1a3a7b@127.0.0.1:21005?discport=0", {from: "0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").nodeList
[{
    orgId: "ORG1.SUB1",
    status: 2,
    url: "enode://239c1f044a2b03b6c4713109af036b775c5418fe4ca63b04b1ce00124af00ddab7cc088fc46020cdc783b6207efe624551be4c06a994993d8d70f684688fb7cf@127.0.0.1:21006?discport=0"
...
Org admin can manage the status of the nodes by using [updateNodeStatus](../Permissioning%20apis#smilopermission_updatenodestatus) API. To deactivate a node the API can be invoked with action 1.
```javascript
> smiloPermission.getOrgDetails("ORG1.SUB1").nodeList
[{
    orgId: "ORG1.SUB1",
...
To activate the node back invoke [updateNodeStatus](../Permissioning%20apis#smilopermission_updatenodestatus) API with action 2.
```javascript
> smiloPermission.updateNodeStatus("ORG1.SUB1", "enode://eacaa74c4b0e7a9e12d2fe5fee6595eda841d6d992c35dbbcc50fcee4aa86dfbbdeff7dc7e72c2305d5a62257f82737a8cffc80474c15c611c037f52db1a3a7b@127.0.0.1:21005?discport=0",2, {from:"0x42ef6abedcb7ecd3e9c4816cd5f5a96df35bb9a0"})
"Action completed successfully"
> smiloPermission.getOrgDetails("ORG1.SUB1").nodeList
[{
    orgId: "ORG1.SUB1",
...
To blacklist a node invoke [updateNodeStatus](../Permissioning%20apis#smilopermission_updatenodestatus) API with action 3. Once blacklisted the node will never be able join the network again.
```javascript
> smiloPermission.getOrgDetails("ORG1.SUB1").nodeList
[{
    orgId: "ORG1.SUB1",
...
If there is a need to temporarily suspend all activities of an organization [updateOrgStatus](../Permissioning%20apis#smilopermission_updateorgstatus) API can be invoked with action 1. This can be invoked only by the network admin accounts and will reuiqre majority voting.
```javascript
> smiloPermission.updateOrgStatus("ORG1", 1, {from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d"})
"Action completed successfully"
> smiloPermission.orgList[2]
{
  fullOrgId: "ORG1",
  level: 1,
  orgId: "ORG1",
...
To approve the org, suspension majority approval from other network admin accounts is required. The api for the same is [approveOrgStatus](../Permissioning%20apis#smilopermission_approveorgstatus). Once approved the org status is marked as suspended.
```javascript
> smiloPermission.approveOrgStatus("ORG1", 1, {from: "0xca843569e3427144cead5e4d5999a3d0ccf92b8e"})
"Action completed successfully"
> smiloPermission.orgList[2]
{
  fullOrgId: "ORG1",
...
To revoke the suspension of an org [updateOrgStatus](../Permissioning%20apis#smilopermission_updateorgstatus) can be called with action as 2. This will require majority approval (API [approveOrgStatus](../Permissioning%20apis#smilopermission_approveorgstatus) with action 2). 
```javascript
> smiloPermission.updateOrgStatus("ORG1", 2, {from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d"})
"Action completed successfully"
> smiloPermission.approveOrgStatus("ORG1", 2, {from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d"})
"Action completed successfully"
> smiloPermission.orgList[0]
{
  fullOrgId: "ORG1.SUB1",
  level: 2,
  orgId: "SUB1",
...
To assign network admin or org admin role to an account invoke [assignAdminRole](../Permissioning%20apis#smilopermission_assignadminrole).
```javascript
> smiloPermission.assignAdminRole("ORG1", "0x0638e1574728b6d862dd5d3a3e0942c3be47d996", "ADMIN", {from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d"})
"Action completed successfully"
> smiloPermission.acctList[3]
{
  acctId: "0x0638e1574728b6d862dd5d3a3e0942c3be47d996",
  isOrgAdmin: true,
  orgId: "ORG1",
...
To approve the assignment of network admin role invoke [approveAdminRole](../Permissioning%20apis#smilopermission_approveadminrole) API.
```javascript
> smiloPermission.approveAdminRole("ORG1", "0x0638e1574728b6d862dd5d3a3e0942c3be47d996", {from: eth.accounts[0]})
"Action completed successfully"
> smiloPermission.acctList[4]
{
  acctId: "0x0638e1574728b6d862dd5d3a3e0942c3be47d996",
  isOrgAdmin: true,
  orgId: "ORG1",
